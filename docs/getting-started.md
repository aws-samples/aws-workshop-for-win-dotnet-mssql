...
If you are doing this workshop as part of an AWS sponsored event that provides AWS credits to cover the costs, use the below instructions for entering the credits:
...
??? info "Click here if the workshop you are doing requires a Cloud9 instance" 
	...
	3.  Enter a **Name** (msft-workshop-ide) and click **Next step**.
